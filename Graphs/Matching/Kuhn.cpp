 ...
 * bipartito. el grafo g debe de ser una lista de los
 * vecinos de la particion izquierda y m el numero de nodos
 * en la particion derecha. Retorna (Numero de
 * emparejamientos, btoa[]) donde btoa[i] sera el
