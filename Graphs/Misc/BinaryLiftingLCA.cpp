/**
 * Descripcion: siendo jump[i][j] el ancestro 2^j del nodo
 * i, el binary liftingnos permite obtener el k-esimo
 * ancestro de cualquier nodo en tiempo logaritmico, una
 * aplicacion de esto es para obtener el ancestro comun mas
 * bajo (LCA). Importante inicializar jump[i][0] para todo
 * i.
