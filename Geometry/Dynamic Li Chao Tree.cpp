/*
* El Árbol de Li-Chao es una estructura de datos utilizada en 
* algoritmos de programación dinámica y geométrica para realizar 
* consultas de máximo (o mínimo) en un conjunto de puntos en una línea (o un plano).
* Complejidad : 
